...
static void usage(const char *program) {
    fprintf(stderr,
        ...
        "      --int8-streaming   Stream cached INT8 DiT layers from SSD\n"
        ...
        "      (int8 is the default on supported backends: MLP always, QKV and\n"
        "      attention output at sequence >= 128. Combine the three\n"
        "      --use-slower-bf16-* flags to force the pure BF16 path.)\n"
